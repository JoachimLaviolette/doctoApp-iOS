...
struct Strings {
    ...
    public static let SHOW_BOOKING_APPOINTMENT_CANCEL_APPOINTMENT_POPUP_CONTENT_APPOINTMENT_DATE: String = "{appointment_date}"
    public static let SHOW_BOOKING_APPOINTMENT_CANCEL_APPOINTMENT_POPUP_CONTENT_APPOINTMENT_DATE_PREFIX: String = "on "
    public static let SHOW_BOOKING_APPOINTMENT_CANCEL_APPOINTMENT_POPUP_CONTENT_APPOINTMENT_TIME: String = "{appointment_time}"
    public static let SHOW_BOOKING_APPOINTMENT_CANCEL_APPOINTMENT_POPUP_CONTENT_APPOINTMENT_TIME_PREFIX: String = "at "
    public static let SHOW_BOOKING_APPOINTMENT_CANCEL_APPOINTMENT_POPUP_CONTENT_DOCTOR_FULLNAME: String = "{doctor_fullname}"
